<template>
  <div class="container " style="min-height: 597px;">
    <div class="section section-first">
      <div class="block form js-form">
        ...
        <div class="block-item">
          <label>联系电话</label>
          <input type="number" placeholder="联系电话" name="tel" v-model.number="tel" oninput="if(value.length>11)value=value.slice(0,11)"
    ...
    <div class="block stick-bottom-row center js-save-default " >
      <button class="btn btn-standard js-save-default-btn" v-show="type==='edit'" >设为默认收货地址</button>
    </div>
  </div>
</template>
